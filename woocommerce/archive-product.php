...
$dream_customizer_shop_option = function_exists('fw_get_db_customizer_option') ? fw_get_db_customizer_option('shop_settings') : array('products_in_row' => 4);
						...
						<?php if ( have_posts() ) : ?>
							...
							<?php woocommerce_product_loop_start(); ?>
								...
								<div class="bt-row">
									...
									?><div class="bt-col-<?php echo esc_attr( (int) $dream_customizer_shop_option['products_in_row']); ?> product-item">
