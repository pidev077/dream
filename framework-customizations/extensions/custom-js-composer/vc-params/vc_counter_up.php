...
class vcCounterUp extends WPBakeryShortCode {
    ...
    public function vc_counter_up_mapping() {
        ...
        vc_map(
            array(
                'name' => __( 'Counter Up', 'dream' ),
                'base' => 'vc_counter_up',
                'description' => __('Counter Up', 'dream'),
                ...
                'params' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => __('Counter number', 'dream'),
                        'param_name' => 'counter_number',
                        'description' => __('Enter number', 'dream'),
                        // 'group' => 'Source',
                        'value' => '2,846',
                    ),
                    array(
              				...
              				'settings' => array(
              					'fields' => array(
              						...
              						'line_height',
              						'color',
              						'tag_description' => __( 'Select element tag.', 'dream' ),
              						'text_align_description' => __( 'Select text alignment.', 'dream' ),
              						'font_size_description' => __( 'Enter font size.', 'dream' ),
              						'line_height_description' => __( 'Enter line height.', 'dream' ),
              						'color_description' => __( 'Select heading color.', 'dream' ),
              					),
              				),
                      // 'group' => 'Source',
              			),
                    array(
              				'type' => 'checkbox',
              				'heading' => __( 'Use theme default font family?', 'dream' ),
              				'param_name' => 'use_theme_fonts',
              				'value' => array( __( 'Yes', 'dream' ) => 'yes' ),
              				'description' => __( 'Use font family from the theme.', 'dream' ),
                      // 'group' => 'Source',
              			),
                    array(
              				'type' => 'google_fonts',
              				...
              				'settings' => array(
              					'fields' => array(
              						'font_family_description' => __( 'Select font family.', 'dream' ),
              						'font_style_description' => __( 'Select font styling.', 'dream' ),
              					),
              				),
              				'dependency' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => __('Before prefix', 'dream'),
                        'param_name' => 'before_prefix',
                        'description' => __('Enter before prefix', 'dream'),
                        'group' => 'Counter Setting',
                        'value' => '$',
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => __('After prefix', 'dream'),
                        'param_name' => 'after_prefix',
                        'description' => __('Enter after prefix', 'dream'),
                        'group' => 'Counter Setting',
                        'value' => ' ',
                    ),
                    array(
                        ...
                        'param_name' => 'delay',
                        'description' => __('Enter delay number', 'dream'),
                        'group' => 'Counter Setting',
                        'value' => '10',
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => __('Time', 'dream'),
                        'param_name' => 'time',
                        'description' => __('Enter time number', 'dream'),
                        'group' => 'Counter Setting',
                        'value' => '1000',
                    ),
