...
class vcCountDown extends WPBakeryShortCode {
  ...
  // Element Init
    ...
    public function vc_count_down_mapping() {
        ...
        vc_map(
          array(
            'name' => __('Count Down', 'dream'),
            'base' => 'vc_count_down',
            'description' => __('Count Down', 'dream'),
            ...
            'icon' => get_template_directory_uri() . '/framework-customizations/extensions/custom-js-composer/images/countdown-box.png',
      			'params' => array(
      				array(
      					'type' => 'dropdown',
      					'class' => '',
      					'heading' => __('Template', 'dream'),
      					'param_name' => 'tpl',
      					'value' => array(
      						'Template 1' => 'tpl1',
      						//'Template 2' => 'tpl2'
      					),
      					'description' => __('Select template in this elment.', 'dream')
      				),
      				array(
      					'type' => 'textfield',
      					'holder' => 'div',
      					'class' => '',
      					'heading' => __('Count Down', 'dream'),
      					'param_name' => 'count_down',
      					'value' => '',
      					'description' => __('Please, enter time for example "Jan 5, 2019 15:37:25"', 'dream')
      				),
      				array(
      					'type' => 'textfield',
      					'class' => '',
      					'heading' => __('Extra Class', 'dream'),
      					'param_name' => 'el_class',
      					'value' => '',
      					'description' => __ ( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'dream' )
      				),
      				/* css editor */
      				  array(
      					'type' => 'css_editor',
