...
if ( $row_container == 'container' ) {
	...
	$after_container  = '</div>';
} elseif ( $row_container == 'container_fully' ) {
	$before_container = '<div class="container-fully">';
	$after_container  = '</div>';
} elseif ( $row_container == "custom_width_container" ) {
	$before_container = '<div class="container-custom-width" style="width:' . $row_container_width . ';">';
	$after_container  = '</div>';
}
