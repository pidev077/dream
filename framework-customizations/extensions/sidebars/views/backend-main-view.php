...
<?php if ( fw()->extensions->get( 'sidebars' )->is_missing_config() or (false === fw()->extensions->get( 'sidebars' )->is_missing_config() and !empty($data_positions_options['choices'])) or $cnt_created_sidebars)  : ?>
	<div class="fw-ext-sidebars-wrap-container">
		<div class="fw-ext-sidebars-wrap">
			...
			<h3 class="hndle">
				<span><?php esc_html_e('Manage Sidebars', 'dream');?></span>
                <a class="fw-sidebar-docs fw-docs-link" target="_blank" href="#"><span class="fw-docs-info dashicons dashicons-editor-help"></span><?php esc_html_e('Go to Docs', 'dream'); ?></a>
			</h3>
			<div class="fw-ext-sidebars-desc"><?php esc_html_e('Use this section to create or set sidebars for different pages','dream')?></div>
			...
			<div class="fw-sidebars-tabs-wrapper" style="opacity: 0;" >
				<div class="fw-sidebars-tabs-list">
					<ul>
						<?php if (fw()->extensions->get( 'sidebars' )->is_missing_config() or (false === fw()->extensions->get( 'sidebars' )->is_missing_config() and  !empty($data_positions_options['choices']) )  ) : ?>
							<li><a href="#fw-sidebars-tab-1" class="nav-tab" ><span class="spinner"></span><?php echo esc_html__('For Grouped Pages','dream'); ?></a></li>
							<li><a href="#fw-sidebars-tab-2" class="nav-tab" ><span class="spinner"></span><?php echo esc_html__('For Specific Pages','dream'); ?></a></li>
						<?php endif ?>
						<li <?php echo "{$cnt_created_sidebars}" ? '' : 'class="empty"'; ?> ><a href="#fw-sidebars-tab-3" class="nav-tab" ><?php echo  $cnt_created_sidebars . ' ' . esc_html__('Created','dream'); ?></a></li>
					</ul>
				...
				<div class="fw-sidebars-tabs">
					<div class="fw-inner">
						...
						<div id="fw-sidebars-tab-3" role="tabpanel" class="<?php echo esc_attr( $cnt_created_sidebars ? '' : 'empty' ) ?>" >
