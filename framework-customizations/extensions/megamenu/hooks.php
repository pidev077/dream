...
// the Bears hook
{
	...
	if(!function_exists('_dream_menuitem_filter_content_type_search')) :
		/**
		 * _dream_menuitem_filter_content_type_search
		 *
		 */
		function _dream_menuitem_filter_content_type_search( $content = '', $options ) {
	...
	add_filter( 'dream:menuitem:filter:type:search', '_dream_menuitem_filter_content_type_search', 10, 3 );

	if(!function_exists('_dream_menuitem_filter_content_type_button_donate')) :
		/**
		 * _dream_menuitem_filter_content_type_search
		 *
		 */
		function _dream_menuitem_filter_content_type_button_donate( $content = '', $options ) {
		   	/* check menu item type (default) */
		   	if($options['menu_item_type'] != 'default') return $content;
	...
	add_filter( 'dream:menuitem:filter:type:button_donate', '_dream_menuitem_filter_content_type_button_donate', 10, 3 );

	if(!function_exists('_dream_menuitem_filter_content_type_notification_center')) :
		/**
		 * _dream_menuitem_filter_content_type_notification_center
		 *
		 */
		function _dream_menuitem_filter_content_type_notification_center( $content = '', $options ) {
		   	/* check menu item type (default) */
		   	if($options['menu_item_type'] != 'default') return $content;
					...
					$output[] = implode('', array(
						'<div class="notification-center-item">',
							'<a href="#notification-search" class="" data-notification="notification-search">',
								dream_load_icon_v2(fw_akg('search_notification_settings/icon', $notification_center_opts)),
							'</a>',
						'</div>',
					));
				endif;
					...
					$output[] = implode('', array(
						'<div class="notification-center-item">',
							'<a href="#notification-login" class="" data-notification="notification-login">',
								dream_load_icon_v2(fw_akg('login_notification_settings/icon', $notification_center_opts)),
							'</a>',
						'</div>',
					));
				endif;
					...
					$output[] = implode('', array(
						'<div class="notification-center-item">',
							'<a href="#notification-cart" class="" data-notification="notification-cart">',
								dream_load_icon_v2(fw_akg('cart_notification_settings/icon', $notification_center_opts)),
	...
	add_filter( 'dream:menuitem:filter:type:notification_center', '_dream_menuitem_filter_content_type_notification_center', 10, 3 );

	if(!function_exists('_dream_menuitem_filter_content_type_offcanvasmenu')) :
		/**
		 * _dream_menuitem_filter_content_type_offcanvasmenu
		 *
		 */
		function _dream_menuitem_filter_content_type_offcanvasmenu( $content = '', $options ) {
			/* check menu item type (default) */
		   	if($options['menu_item_type'] != 'default') return $content;
	...
	add_filter( 'dream:menuitem:filter:type:off-cavans-menu', '_dream_menuitem_filter_content_type_offcanvasmenu', 10, 2 );

	if(!function_exists('_dream_menuitem_filter_content_type_html')) :
		/**
		 * _dream_menuitem_filter_content_type_html
		 */
		function _dream_menuitem_filter_content_type_html( $content = '', $options ) {
			/* check menu item type (default) */
		   	if($options['menu_item_type'] != 'default') return $content;
	...
	add_filter( 'dream:menuitem:filter:type:html', '_dream_menuitem_filter_content_type_html', 10, 2 );

	if(!function_exists('_dream_menuitem_filter_content_type_sidebar')) :
		/**
		 * _dream_menuitem_filter_content_type_sidebar
		 */
		function _dream_menuitem_filter_content_type_sidebar( $content = '', $options ) {
			/* check menu item type (default) */
		   	if($options['menu_item_type'] != 'default') return $content;
	...
	add_filter( 'dream:menuitem:filter:type:sidebar', '_dream_menuitem_filter_content_type_sidebar', 10, 2 );

	if(!function_exists('_dream_megamenuitem_filter_content_type_sidebar')) :
		/**
		 * _dream_megamenuitem_filter_content_type_sidebar
		 *
		 */
		function _dream_megamenuitem_filter_content_type_sidebar( $content = '', $options ) {
			/* check menu item type (default) */
	...
	add_filter( 'dream:megamenuitem:filter:type:sidebar', '_dream_megamenuitem_filter_content_type_sidebar', 10, 2 );

	if(!function_exists('_dream_menuitem_filter_content_type_woocommerce_mini_cart')) :
		/**
		 * _dream_menuitem_filter_content_type_woocommerce_mini_cart
		 *
		 */
		function _dream_menuitem_filter_content_type_woocommerce_mini_cart( $content = '', $options ) {
			/* check menu item type (default) */
			if($options['menu_item_type'] != 'default') return $content;
				...
				<div class="minicart-products-container bearsthemes_minicart_products_container_elem">
					<div class="widget_shopping_cart_content">
						<ul class="cart_list product_list_widget ">
							<li class="empty">'. esc_html__('No products in the cart!', 'dream') .'</li>
						</ul><!-- end product list -->
					</div>
				</div>
			</div>';
	...
	add_filter( 'dream:menuitem:filter:type:woocommerce-mini-cart', '_dream_menuitem_filter_content_type_woocommerce_mini_cart', 10, 2 );
}
