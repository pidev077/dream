...
# BEGIN - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...

		{
			...
			if(isset($extra_options['menu_type']['selected']) && !empty($extra_options['menu_type']['selected'])) {
				$item_output = apply_filters( 'dream:menuitem:filter:type:' . $extra_options['menu_type']['selected'], $item_output, $extra_options );
			}
		}

		{
			...
			if(isset($extra_options['mega_menu_type']['selected']) && !empty($extra_options['mega_menu_type']['selected'])) {
				...
				$item_output = apply_filters( 'dream:megamenuitem:filter:type:' . $extra_options['mega_menu_type']['selected'], $item_output, $extra_options );
			}
		}
# END - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
