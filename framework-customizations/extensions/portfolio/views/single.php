...
$dream_portfolio_settings = dream_get_options_portfolio();
$dream_portfolio_single_settings = $dream_portfolio_settings['portfolio_single'];
...
<section class="bt-main-row bt-section-space <?php dream_get_content_class( 'main', $dream_sidebar_position ); ?>" role="main" itemprop="mainEntity" itemscope="itemscope" itemtype="http://schema.org/Blog">
	<div class="container">
		<div class="row">
									...
									<div class="row">
				            			...
				            			?>
												...
												<div class="social-share-entry">
													<?php echo dream_share_post(array('facebook' => true, 'twitter' => true, 'google_plus' => true, 'linkedin' => true, 'pinterest' => false)); ?>
												</div>
												...
												<?php if($prevPost || $nextPost) : ?>
													<ul class="previous-next-link">
													    ...
													    <li class="previous">
													      ...
													      <?php previous_post_link('%link', $prevthumbnail . '<div><div class="icon"><span class="ion-ios-arrow-thin-left"></span> '.__('Previous', 'dream').'</div> <div class="title">%title</div></div>'); ?>
													    </li>
														<?php } if($nextPost) { ?>
													    <li class="next">
													    	<?php $nextthumbnail = get_the_post_thumbnail($nextPost->ID, array(80,80) ); ?>
													      <?php next_post_link('%link', $nextthumbnail . '<div><div class="icon">'.__('Next', 'dream').' <span class="ion-ios-arrow-thin-right"></span></div> <div class="title">%title</div></div>'); ?>
													    </li>
														<?php } ?>
													</ul>
												<?php endif; ?>
            ...
            <?php
						if ($dream_portfolio_single_settings['show_comment'] == 'yes') comments_template();
						break;
					endwhile; ?>
				</div><!-- /.bt-col-inner -->
			</div><!-- /.bt-content-area -->
