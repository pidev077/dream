		...
		<div class="row">
			<div class="bt-content-area <?php dream_get_content_class( 'content', $dream_sidebar_position ); ?>">
				<div class="bt-col-inner">
					...
					<?php
					/* portfolio filter */
					if($dream_portfolio_settings['show_filter'] == 'yes'){
						echo dream_builder_filter_taxonomy_portfolio();
					}
					?>
					<div class="portfolio-list" data-bears-masonryhybrid='{"col": <?php echo esc_attr( (int) $dream_portfolio_settings['number_portfolio_in_row'] ); ?>}' data-bears-lightgallery='{"selector": ".zoom-image"}'>
						<div class="grid-sizer"></div>
						<div class="gutter-sizer"></div>
						<?php if ( have_posts() ) :
							while ( have_posts() ) : the_post();
								get_template_part( 'framework-customizations/extensions' . $ext_portfolio_instance->get_rel_path() . '/views/loop', $dream_portfolio_settings['portfolio_type'] );
							endwhile;
						else :
