...
class Widget_FW_Posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'description' => esc_html__( "Popular/Recent/Most Commented Posts.", "dream" ) );

		parent::__construct( false, esc_html__( 'Posts - BT', 'dream' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'posts_number' ) ); ?>"><?php esc_html_e( 'Number of Posts to Show:', 'dream' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php esc_html_e( 'Select Type:', 'dream' ); ?></label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'type' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>" class="widefat">
				<option value="recent" <?php selected( $instance['type'], 'recent' ); ?>><?php esc_html_e( 'Recent Posts', 'dream' ); ?></option>
				<option value="popular" <?php selected( $instance['type'], 'popular' ); ?>><?php esc_html_e( 'Popular Posts', 'dream' ); ?></option>
				<option value="commented" <?php selected( $instance['type'], 'commented' ); ?>><?php esc_html_e( 'Most Commented Posts', 'dream' ); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'days' ) ); ?>"><?php esc_html_e( 'Select Days:', 'dream' ); ?></label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'days' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'days' ) ); ?>" class="widefat">
				<option value="" <?php selected( $instance['days'], '' ); ?>><?php esc_html_e( 'All time', 'dream' ); ?></option>
				<option value="7" <?php selected( $instance['days'], '7' ); ?>><?php esc_html_e( '1 Week', 'dream' ); ?></option>
				<option value="30" <?php selected( $instance['days'], '30' ); ?>><?php esc_html_e( '1 Month', 'dream' ); ?></option>
				<option value="90" <?php selected( $instance['days'], '90' ); ?>><?php esc_html_e( '3 Month', 'dream' ); ?></option>
				<option value="180" <?php selected( $instance['days'], '180' ); ?>><?php esc_html_e( '6 Month', 'dream' ); ?></option>
				<option value="360" <?php selected( $instance['days'], '360' ); ?>><?php esc_html_e( '1 Year', 'dream' ); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select Category:', 'dream' ); ?></label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>" class="widefat">
				<option value="" <?php selected( $instance['category'], '' ); ?>><?php esc_html_e( 'All Categories', 'dream' ); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_images' ) ); ?>"><?php esc_html_e( 'Display Images?', 'dream' ); ?></label>
		</p>
		<p>
