...
class Widget_FW_Login extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'description' => esc_html__( 'A login form widget.', 'dream' ) );

		parent::__construct( false, esc_html__( 'Login - BT', 'dream' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_remember' ) ); ?>"><?php esc_html_e( 'Show remember button', 'dream' ); ?></label><br/>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_forgot' ) ); ?>"><?php esc_html_e( 'Show forgot password', 'dream' ); ?></label><br/>
		</p>
	<?php
	}
}