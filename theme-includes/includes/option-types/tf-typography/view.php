...
<div <?php echo fw_attr_to_html($wrapper_attr) ?>>
	...
	<?php if ( $components['family'] ) : ?>
		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-family fw-border-box-sizing fw-col-sm-5">
			...
			<div class="fw-inner"><?php esc_html_e('Font face', 'dream'); ?></div>
		</div>

		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-style fw-border-box-sizing fw-col-sm-3" style="display: <?php echo esc_attr(($google_font) ? 'none' : 'inline-block'); ?>;">
			<select data-type="style" name="<?php echo esc_attr($option['attr']['name']) ?>[style]" class="fw-option-tf-typography-option-style-input">
					<?php foreach (
						array(
							'normal'  => esc_html__('Normal', 'dream'),
							'italic'  => esc_html__('Italic', 'dream'),
							'oblique' => esc_html__('Oblique', 'dream')
						)
						as $key => $style): ?>
			...
			<div class="fw-inner"><?php esc_html_e('Style', 'dream'); ?></div>
		</div>

		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-weight fw-border-box-sizing fw-col-sm-3" style="display: <?php echo esc_attr(($google_font) ? 'none' : 'inline-block'); ?>;">
			...
			<div class="fw-inner"><?php esc_html_e('Weight', 'dream'); ?></div>
		</div>

		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-subset fw-border-box-sizing fw-col-sm-2" style="display: <?php echo esc_attr(($google_font) ? 'inline-block' : 'none'); ?>;">
			...
			<div class="fw-inner"><?php esc_html_e('Script', 'dream'); ?></div>
		</div>

		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-variation fw-border-box-sizing fw-col-sm-2" style="display: <?php echo esc_attr(($google_font) ? 'inline-block' : 'none'); ?>;">
	...
	<?php if ( $components['size'] ) : ?>
		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-size fw-border-box-sizing fw-col-sm-2">
			...
			<div class="fw-inner"><?php esc_html_e('Size', 'dream'); ?></div>
		</div>
	<?php endif; ?>
	...
	<?php if ( $components['line-height'] ) : ?>
		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-line-height fw-border-box-sizing fw-col-sm-2">
			...
			<div class="fw-inner"><?php esc_html_e('Line height', 'dream'); ?></div>
		</div>
	<?php endif; ?>
	...
	<?php if ( $components['letter-spacing'] ) : ?>
		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-letter-spacing fw-border-box-sizing fw-col-sm-2">
			...
			<div class="fw-inner"><?php esc_html_e('Letter spacing', 'dream'); ?></div>
		</div>
	<?php endif; ?>
	...
	<?php if ( $components['color-palette'] ) : ?>
		<div class="fw-option-tf-typography-option fw-option-tf-typography-option-color-palette fw-border-box-sizing fw-col-sm-2" data-type="color-palette">
			...
			?>
			<div class="fw-inner"><?php esc_html_e('Color', 'dream'); ?></div>
		</div>
	<?php endif; ?>
</div>
