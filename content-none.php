...
<div class="entry-content bt-content-none" itemprop="text">
	<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'dream' ); ?></h2>
	<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
		<p><?php printf( esc_html__( 'Ready to publish your first post?', 'dream').' <a href="%1$s">'.esc_html__( 'Get started here', 'dream').'</a>.', admin_url( 'post-new.php' ) ); ?></p>
