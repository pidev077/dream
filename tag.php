...
?>
<section class="1 bt-main-row bt-section-space <?php dream_get_content_class('main', $dream_sidebar_position); ?>" role="main" itemprop="mainEntity" itemscope="itemscope" itemtype="http://schema.org/Blog">
					...
					<div class="postlist" data-bears-masonryhybrid='{"col": <?php echo esc_attr($dream_general_posts_options['number_post_in_row']); ?>, "space": 40}'>
						...
						<?php if ( have_posts() ) :
							while ( have_posts() ) : the_post();
								get_template_part( 'templates/'.$dream_general_posts_options['blog_type'].'/content', get_post_format() );
							endwhile;
						else :
